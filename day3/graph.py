...
tavily = TavilyClient(api_key="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")
...
class GraphState(TypedDict):
    ...
    generation: str = None
    web_search: str = None
    is_web_search_failed: bool
    is_halluciation_failed: bool
...
def main():
    ...
    def failed(state):
        return {"generation": "Failed to relevance check. "}

    def failed_halluciation(state):
        return {"generation": "Failed to halluciaiton check. "}
    ...
    workflow.add_node("failed_halluciation", failed_halluciation)
